"""
Django settings for misty_disk_48181 project.
...
ROOT_URLCONF = 'misty_disk_48181.urls'
...
WSGI_APPLICATION = 'misty_disk_48181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_disk_48181 API",
    "DESCRIPTION": "API documentation for misty_disk_48181 App",
    "VERSION": "v1",
}
